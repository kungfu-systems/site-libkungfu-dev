...
| 2026-08-11 | open-minor | `skills-preview-surface/v1` | primary navigation, `/skills/`, Skills manifest, llms, architecture, capability map, root manifest | additive | The site adds one source-pinned Skills preview generated from a single fixture, preserves Human/Agent parity and explicit current/future/non-claim boundaries, and stays on the existing hub preview without claiming a released Skill runtime. | |
