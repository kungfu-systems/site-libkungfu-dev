...
| 2026-08-10 | open-minor | `kfx-developer-surface/v1` | primary navigation, KFX reader path, `/kfx/`, KFX manifest, llms, architecture, capability map, root manifest | additive | The site adds a source-pinned KFX reader synthesis and equivalent human and Agent graphs while preserving every existing surface, keeping authority upstream, and consuming no unpublished npm package. | |
