...
writeFile(
  ...
  page({
    ...
    canonicalUrl: surfaceEndpointHref("hub", "dogfood/"),
    ...
    socialImage: surfaceEndpointHref("hub", "assets/social/dogfood-public-evidence.png"),
...
writeFile(
  ...
  page({
    ...
    canonicalUrl: surfaceEndpointHref("hub", "dogfood/parallel-runtime-paths/"),
    ...
    socialImage: surfaceEndpointHref("hub", "assets/social/parallel-runtime-paths.png"),
