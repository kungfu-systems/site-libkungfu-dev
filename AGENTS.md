...
- Render bundle-declared KFD usage and formal reference children as subordinate
  pages. Preserve the decision document as authority and expose each child's
  relationship, normative status, model metadata, and source path.
